...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/home/guillaume/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/guillaume/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["vim-gutentags"] = {
    loaded = true,
    path = "/home/guillaume/.local/share/nvim/site/pack/packer/start/vim-gutentags",
    url = "https://github.com/ludovicchabant/vim-gutentags"
  },
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/home/guillaume/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
